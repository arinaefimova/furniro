(() => {
    ...
    if (document.querySelector(".slider-rooms__body")) new Swiper(".slider-rooms__body", {
        slidesPerView: "auto",
        observer: true,
        observeParents: true,
        spaceBetween: 24,
    ...
    if (document.querySelector(".slider-tips__body")) new Swiper(".slider-tips__body", {
        slidesPerView: 3,
        observer: true,
        observeParents: true,
        spaceBetween: 32,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 768 && isMobile.any()) {
                ...
                if (!targetElement.closest(".menu__item") && document.querySelectorAll(".menu__item.hover").length > 0) removeClasses(document.querySelectorAll(".menu__item.hover"), "hover");
            }
            if (targetElement.classList.contains("search-form__icon")) document.querySelector(".search-form").classList.toggle("active"); else if (!targetElement.closest(".search-form") && document.querySelectorAll(".search-form.active")) document.querySelector(".search-form").classList.remove("active");
        ...
        const callback = function(enteries, observer) {
            if (enteries[0].isIntersecting) headerElement.classList.remove("_scroll"); else headerElement.classList.add("_scroll");
        };
        ...
        function addToCart(productButton, productId) {
            if (!productButton.classList.contains("_hold")) {
                ...
                const productImageFlyHeight = productImage.offsetHight;
